              ...
              <div className="p-2">
                ...
                <div className="flex max-sm:flex-col justify-between items-center mt-3 max-sm:mt-1">
                  ...
                  <button
                    ...
                    className="bg-blue-500 max-sm:mt-1 text-white font-bold px-3 py-2 max-sm:text-xs max-sm:px-2 max-sm:py-1 max-sm:text-normal text-sm text-medium rounded-lg hover:bg-blue-600"
                  >
                    Book Now
                  </button>
                </div>
